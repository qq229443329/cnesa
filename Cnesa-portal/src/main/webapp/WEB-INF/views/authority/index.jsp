...
<div id="index_layout">
    ...
    <div data-options="region:'west',split:true" title="菜单" style="width: 180px; overflow: hidden;overflow-y:auto; padding:0px">
    ...
    <div data-options="region:'south',border:false" style="height: 30px;line-height:30px; overflow: hidden;text-align: center;background-color: #eee" >Copyright © 2015 power by <a href="http://www.esonline.cn/" target="_blank">XXX(北京)科技有限公司</a></div>
</div>
