...
<script type="text/javascript">
    $(function() {
        ...
        $("#functionType").val('${resource.functionType}');
        $("#stateId").val('${resource.state}');
    });
</script>
<div style="padding: 3px;">
    <form id="resourceEditForm" method="post">
        <table  class="grid">
            ...
            <tr>
                <td>菜单描述</td>
                <td ><input  name="description" value="${resource.description}"/></td>
                <td>菜单功能</td>
                <td >
                    <select id="functionType" name="functionType" class="easyui-combobox" data-options="width:140,height:29,editable:false,panelHeight:'auto'">
            ...
            <tr>
                <td>上级资源</td>
                <td><select id="parentId" name="parentId" style="width: 130px; height: 29px;"></select>
