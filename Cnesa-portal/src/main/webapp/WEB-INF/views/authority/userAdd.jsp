        ...
        $('#comId').combotree({
            ...
            onLoadSuccess : function () {
                ...
                if (node != undefined) {
                    ...
                    $("#comId").combotree('setValue', node.id);
                }
    ...
    <div data-options="region:'center',border:false" title="" style="overflow: hidden;padding: 3px;">
        <form id="userAddForm" method="post">
            <table class="grid">
                ...
                <tr>
                    <td>部门</td>
                    <td><select id="orgId" name="orgId" style="width: 140px; height: 29px;" class="easyui-validatebox" data-options="required:true"></select></td>
                    <td>角色</td>
                ...
                <tr>
                    <td>所属企业</td>
                    <td><select id="comId" name="comId" style="width: 140px; height: 29px;" class="easyui-combobox easyui-validatebox" data-options="required:true"></select></td>
                    <td></td>
                    <td></td>
                </tr>
            </table>
